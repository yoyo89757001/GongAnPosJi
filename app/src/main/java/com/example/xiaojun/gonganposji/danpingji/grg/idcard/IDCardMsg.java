package com.example.xiaojun.gonganposji.danpingji.grg.idcard;
...
public class IDCardMsg {
	...
	private IDCardDate usefulEndDate;//结束日期
...
//	public byte[] fingerPrint;
	...
	public IDCardDate getUsefulEndDate() {
		return usefulEndDate;
	}

	void setUsefulEndDate(IDCardDate usefulEndDate) {
