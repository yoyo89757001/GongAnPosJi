package com.example.xiaojun.gonganposji.utils;
...
public class PreferData {
	...
	private static final String FILENAME =  "readdemo.conf";
	...
	public String readString(String data, String defaultValue) {
		String result;
		result = saveprefer.getString(data, defaultValue);
		return result;
	}
	public int readInt(String data) {
		int result;
		result = saveprefer.getInt(data, 0);
		return result;
	}
