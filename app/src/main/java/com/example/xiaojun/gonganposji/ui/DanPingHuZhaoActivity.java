...
public class DanPingHuZhaoActivity extends Activity implements View.OnClickListener {
   ...
   // private boolean isA=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_danping_hu_zhao);
        ...
        if (baoCunBean!=null && baoCunBean.getZhuji()!=null){
            ...
            Toast tastyToast= TastyToast.makeText(DanPingHuZhaoActivity.this,"请先设置主机地址",TastyToast.LENGTH_LONG,TastyToast.ERROR);
        ...
        String fn2 = "dddddd.jpg";
        FileUtil.isExists(FileUtil.PATH, fn2);
        benrenFile=new File( FileUtil.SDPATH + File.separator + FileUtil.PATH + File.separator + fn2);
       ...
       // videoView.setAspectRatio(3, 4);
        ...
        tuifang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DanPingHuZhaoActivity.this, DatePickActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.zhengjianim: //第一张
                //证件照
                Log.d("DanPingHuZhaoActivity", "点击");
                startCamera(1);
            ...
            case R.id.xianchangim: //第二张
                //本人照
                startCamera(2);
                Log.d("DanPingHuZhaoActivity", "点击333");
                break;
            case R.id.baocun:
                if (!fanghao.getText().toString().equals("") && !userInfoBena.getScanPhoto().equals("") && !userInfoBena.getCardPhoto().equals("")){
                    ...
                    Toast tastyToast= TastyToast.makeText(DanPingHuZhaoActivity.this,"你没有填写房号或拍照",TastyToast.LENGTH_LONG,TastyToast.ERROR);
                    tastyToast.setGravity(Gravity.CENTER,0,0);
                    tastyToast.show();
                }
            ...
            switch (requestCode) {
                case REQUEST_TAKE_PHOTO:  //拍照
                 ...
                 //   huzhaoim.setImageURI(Uri.fromFile());
                    Glide.with(DanPingHuZhaoActivity.this)
                            .load(mSavePhotoFile)
    ...
    private void startCamera(int i) {
        if (i==1){
            ...
            if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                ...
                if (benrenFile != null) {
                    takePictureIntent.putExtra(MediaStore.EXTRA_OUTPUT,
                            Uri.fromFile(benrenFile));//设置文件保存的URI
...
//            link_P2();
    ...
    private void link_P1(File filename1 ) {
        jiaZaiDialog=new JiaZaiDialog(DanPingHuZhaoActivity.this);
        jiaZaiDialog.setCanceledOnTouchOutside(false);// 设置点击屏幕Dialog不消失
        jiaZaiDialog.setText("上传图片中...");
        if (!DanPingHuZhaoActivity.this.isFinishing()){
            jiaZaiDialog.show();
        }
...
//        String boundary = "xx--------------------------------------------------------------xx";
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast tastyToast= TastyToast.makeText(DanPingHuZhaoActivity.this,"上传图片出错，请返回后重试！",TastyToast.LENGTH_LONG,TastyToast.ERROR);
                        tastyToast.setGravity(Gravity.CENTER,0,0);
                        tastyToast.show();
    ...
    private void link_P2(File file) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                jiaZaiDialog=new JiaZaiDialog(DanPingHuZhaoActivity.this);
...
//        String boundary = "xx--------------------------------------------------------------xx";
        ...
        if (!DanPingHuZhaoActivity.this.isFinishing() && tiJIaoDialog==null  ){
            tiJIaoDialog=new TiJIaoDialog(DanPingHuZhaoActivity.this);
            if (!DanPingHuZhaoActivity.this.isFinishing())
            tiJIaoDialog.show();
        }
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast tastyToast = TastyToast.makeText(DanPingHuZhaoActivity.this, "网络出错,请检查网络", TastyToast.LENGTH_LONG, TastyToast.ERROR);
                        tastyToast.setGravity(Gravity.CENTER, 0, 0);
                        tastyToast.show();
                        ...
                        if (bean.getDtoResult()==0) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Toast tastyToast = TastyToast.makeText(DanPingHuZhaoActivity.this, "保存成功", TastyToast.LENGTH_LONG, TastyToast.INFO);
                                    tastyToast.setGravity(Gravity.CENTER, 0, 0);
                                    tastyToast.show();
                                    finish();
                                }
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Toast tastyToast = TastyToast.makeText(DanPingHuZhaoActivity.this, "保存失败", TastyToast.LENGTH_LONG, TastyToast.ERROR);
                                    tastyToast.setGravity(Gravity.CENTER, 0, 0);
                                    tastyToast.show();
